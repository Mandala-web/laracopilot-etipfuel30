...
class ProfileSectionResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Section Profile';
    protected static ?string $modelLabel = 'Section Profile';
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('content_type')->label('Tipe')->badge(),
    ...
    {
        return [
            'index' => Pages\ManageProfileSections::route('/'),
        ];
    }
}